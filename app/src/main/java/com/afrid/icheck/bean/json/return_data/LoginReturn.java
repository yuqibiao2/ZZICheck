...
import com.afrid.icheck.bean.json.ServiceTHospital;
...
public class LoginReturn implements Serializable{
    ...
    public static class ResultDataBean {
        ...
        private List<ServiceTHospital> hospitalList;
        ...
        public List<ServiceTHospital> getHospitalList() {
            return hospitalList;
        }

        public void setHospitalList(List<ServiceTHospital> hospitalList) {
